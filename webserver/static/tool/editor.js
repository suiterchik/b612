    ...
    var methods = {
        ...
        imageWidget: function () {
            ...
            var getURL = $("<button/>", {
                ...
                var image = $('<img/>', {
                    ...
                    methods.showMessage.apply(this, ["imgErrMsg", "图片url非法"]);
                    return false;
                }).load(function () {
        ...
        tableWidget: function (mode) {
            ...
            var tblCntr = $('<div/>', { //Outer Container Div
                ...
                id: "tblErrMsg" + idExtn
                ...
                ).append($('<label/>', {for: "tblBorder" + idExtn, text: "边框粗细"}
                )).append($('<input/>', {
                    id: "tblBorder" + idExtn,
                    type: "text",
                    class: "form-control form-control-width",
                    ...
                    class: "form-control form-control-width",
                    value: 1
                })).append($('<label/>', {for: "tblCellpadding" + idExtn, text: "单元格边距"}
                )).append($('<input/>', {
                ...
                'insert_img': {
                    ...
                    "onSave": function () {
                        ...
                        if ($('#imageList').data('current')) {
                            ...
                            methods.showMessage.apply(this, ["imgErrMsg", "请选取一张图片"]);
                            return false;
                        }
                ...
                'insert_table': {
                    ...
                    "onSave": function () {
                        ...
                        if (!tblRows.match(intReg)) {
                            methods.showMessage.apply(this, ["tblErrMsg", "行数必须正整数"]);
                            return false;
                        }
                        if (!tblColumns.match(intReg)) {
                            methods.showMessage.apply(this, ["tblErrMsg", "列数必须为正整数"]);
                            return false;
                        }
                        if (tblWidth != "" && !tblWidth.match(cssReg)) {
                            methods.showMessage.apply(this, ["tblErrMsg", "宽度必须为 正整数+(px,em,ex,%,in,cm,mm,pt,pc)"]);
                            return false;
                        }
        ...
        createImageContext: function (event, cMenuUl) {
            ...
            cMenuUl.append($('<li/>').append(modalTrigger))
                .append($('<li/>').append($('<a/>', {text: "删除图片"}).click(
                    function (e) {
                        return function () {
                            $('#context-menu').remove();
